...
<img src="<!-- Add Home Page SS here -->" alt="Home Page" width="100%" />
<br/>
<img src="<!-- Add Remedy Card SS here -->" alt="Remedy Cards" width="100%" />
<br/>
<img src="<!-- Add Search or Pagination SS here -->" alt="Search Results with Pagination" width="100%" />
<br/>
<img src="<!-- Add Liked Remedies Page SS here -->" alt="Liked Remedies" width="100%" />
<br/>
<img src="<!-- Add Submit Remedy Form SS here -->" alt="Remedy Suggestion Form" width="100%" />
